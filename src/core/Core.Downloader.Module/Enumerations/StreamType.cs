...
{
	/// <summary>
	/// Represents media stream types enumeration.
	/// </summary>
	public sealed class StreamType : Enumeration<StreamType>
	{
		public static StreamType AudioOnly = new(nameof(AudioOnly), 0);
		public static StreamType VideoOnly = new(nameof(VideoOnly), 1);
