...
namespace Core.Downloader.Module.ValueObjects
{
	/// <summary>
	/// Represents a thumbnail for Media item.
	/// </summary>
	public sealed class Thumbnail : ValueObject
	{
		...
		/// <exception cref="ArgumentNullException">Thrown when any param is <see langword="null"/>.</exception>
