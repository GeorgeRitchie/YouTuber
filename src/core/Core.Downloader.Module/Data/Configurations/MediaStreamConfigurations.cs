...
{
	/// <summary>
	/// Represents the <see cref="MediaStream"/> entity configuration.
	/// </summary>
	internal sealed class MediaStreamConfigurations : IEntityTypeConfiguration<MediaStream>
	{
		/// <inheritdoc/>
		public void Configure(EntityTypeBuilder<MediaStream> builder)
		{
			builder.ToTable(TableNames.MediaStreams);

			builder.HasKey(i => i.Id);

			builder.Property(i => i.Id).ValueGeneratedNever();

			builder.Property(i => i.StreamType).HasConversion<EnumerationConverter<StreamType>>();
		}
	}
}
